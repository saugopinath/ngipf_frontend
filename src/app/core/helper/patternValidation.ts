...
export const ValidationObj = {
    ...
    demandCode: { pattern: /^\d{2}$/, errorMsg: 'Must be a string of digits of length 2..(eg. 00 )' },
    majorHd: { pattern: /^\d{4}$/, errorMsg: 'Must be a string of digits of length 4..(eg. 0000)' },
    subMajor: { pattern: /^\d{2}$/, errorMsg: 'Must be a string of digits of length 2..(eg. 00 )' },
    minor: { pattern: /^\d{3}$/, errorMsg: 'Must be a string of digits of length 3..(eg. 000)' },
    scheme: { pattern: /^\d{3}$/, errorMsg: 'Must be a string of digits of length 3..(eg. 000)' },
    votedCharged: { pattern: /^(V|C){1}$/, errorMsg: 'Must be a V or C (eg. V,C)' },
    detailhd: { pattern: /^\d{2}$/, errorMsg: 'Must be a string of digits of length 2..(eg. 00 )' },
};
